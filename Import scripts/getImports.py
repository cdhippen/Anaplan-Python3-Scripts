# This script returns all imports in the selected workspace and model to a json
# array saved in file 'imports.json'. Reference that file for future use.
...
getImports = requests.get(f'https://api.anaplan.com/1/3/workspaces/{wGuid}/' +
                        f'models/{mGuid}/imports',
                        headers=getHeaders)

with open('imports.json', 'wb') as f:
