# This script returns all exports in the selected workspace and model to a json
# array saved in file 'exports.json'. Reference that file for future use.
...
getExports = requests.get(f'https://api.anaplan.com/1/3/workspaces/{wGuid}/' +
                        f'models/{mGuid}/exports',
                        headers=getHeaders)

with open('exports.json', 'wb') as f:
    f.write(getExports.text.encode('utf-8'))
